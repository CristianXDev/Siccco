...
<div class="container-fluid">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div>
            ...
            <div wire:poll.4s class="btn btn-sm btn-danger" style="margin-top:0px; margin-bottom:0px;"> {{ session('error') }} </div>
            @endif
        </div>
    ...
    @include('livewire.beneficios.modals')
        ...
        <table class="table table-stripeed table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $row->tiposBeneficio->nombre }}</td>
                    ...
                    <td width="90">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu position-absolute">
                                ...
                                <li><a class="dropdown-item" onclick="confirm('Confirm Delete Beneficio id {{$row->id}}? \nDeleted Beneficios cannot be recovered!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="bi-trash3-fill"></i> Eliminar</a></li>  
                            </ul>
                        </div>                               
                    </td>
                </tr>
                @empty
                <tr>
                    <td class="text-center" colspan="5">No hay información agregada.</td>
                </tr>
                @endforelse
            </tbody>
        </table>                        

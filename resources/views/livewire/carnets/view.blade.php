...
<div class="container-fluid">
    ...
    @include('livewire.carnets.modals')
        ...
        <table class="table table-stripeed table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ \Carbon\Carbon::parse($row->fecha_emision)->format('d-m-Y') }}</td>
                    <td>{{ \Carbon\Carbon::parse($row->fecha_vencimiento)->format('d-m-Y') }}</td>
                    <td>
                        @if($row->estado == 1)
                    ...
                    <td width="90">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu position-absolute">
                                ...
                                <li><a class="dropdown-item" onclick="confirm('Confirm Delete Carnet id {{$row->id}}? \nDeleted Carnets cannot be recovered!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="bi-trash3-fill"></i> Eliminar</a></li>  
                            </ul>
                        </div>                               
                    </td>
                </tr>
